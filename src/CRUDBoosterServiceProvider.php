<?php namespace crud_booster_voila\crudbooster;

use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\ServiceProvider;
use crud_booster_voila\crudbooster\commands\CrudboosterInstallationCommand;
use crud_booster_voila\crudbooster\commands\CrudboosterUpdateCommand;
...
class CRUDBoosterServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->commands(['\crud_booster_voila\crudbooster\commands\CrudboosterVersionCommand']);
        ...
        $loader->alias('CRUDBooster', 'crud_booster_voila\crudbooster\helpers\CRUDBooster');
        $loader->alias('CB', 'crud_booster_voila\crudbooster\helpers\CB');
    }
