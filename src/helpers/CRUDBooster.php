...
namespace crud_booster_voila\crudbooster\helpers;
...
class CRUDBooster
{
    ...
    public static function getResizeImage($img, $width = null, $height = null)
    {
        ...
        if (!file_exists(public_path('/thumbs/____resize____/' . $name_image))) {
            ...
            if (!file_exists(public_path('/thumbs/____resize____/'))) {
                mkdir(public_path('/thumbs/____resize____/'), 777, true);
            }

            $img->save(public_path('thumbs/____resize____/' . $name_image));
        }
    ...
    public static function getCropImage($img, $width = 100, $height = 100)
    {
	   ...
	   if(!file_exists(public_path("$img")))
            ...
            if (!file_exists(public_path('/thumbs/____crop____/'))) {
                mkdir(public_path('/thumbs/____crop____/'), 777, true);
            }

            $img->save(public_path('thumbs/____crop____/' . $name_image));
        }
    ...
    public static function mainpath($path = null)
    {
        ...
        $controllername = str_replace(["\crud_booster_voila\crudbooster\controllers\\", "App\Http\Controllers\\"], "", strtok(Route::currentRouteAction(), '@'));
...
//             return $primary_key;
    ...
    public static function generateAPI($controller_name, $table_name, $permalink, $method_type = 'post')
    {
		...
		class Api' . $controller_name . 'Controller extends \crud_booster_voila\crudbooster\controllers\ApiController {
...
<?php namespace App\Http\Controllers;
	...
	class Admin' . $controllername . ' extends \crud_booster_voila\crudbooster\controllers\CBController {
