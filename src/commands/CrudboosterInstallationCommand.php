<?php namespace crud_booster_voila\crudbooster\commands;
...
class CrudboosterInstallationCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if ($this->confirm('Do you have setting the database configuration at .env ?')) {
            ...
            $this->call('vendor:publish', ['--provider' => 'crud_booster_voila\crudbooster\CRUDBoosterServiceProvider']);
            ...
            $configLFMModified = str_replace("['web','auth']", "['web','\crud_booster_voila\crudbooster\middlewares\CBBackend']", $configLFM);
